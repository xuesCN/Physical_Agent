...
| 3 | 退役 Markdown migration，缩成 safety/log sidecar | ✅ R3-A `e7f878b`、R3-B `a64be59`、R3-C `d1713a0`、R3-D `6309a1b`、R3-E `4a8ec86`、R3-F `9698b3e` 完成；下一步 R4 | 当前树与 wheel 均无 migrator/full Workspace；sidecar 等价；旧目录 fail closed；历史救援可执行 |
