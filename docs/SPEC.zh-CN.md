...
| T4 | MOCE TUI 品牌与终端视觉刷新 | `PLAYBOOK` T4 + `superpowers/specs/2026-07-17-tui-moce-visual-refresh-design.md` | 🟡 2026-07-17：用户以真实终端截图明确要求重启，已批准“启动大 Logo + 常驻紧凑标题栏”的克制品牌化方案及书面设计；实施计划见 `superpowers/plans/2026-07-17-tui-moce-visual-refresh.md`。范围只含 TUI 展示与对应测试，不改变 API/watch/driver/SafetyGate 或解冻其他功能 |
